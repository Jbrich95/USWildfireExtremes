...
checkpoint <- callback_model_checkpoint(
  paste0(
    "intermediates/models/bGEV_local_PINN_homo_xi_fit/boot_",
    boot.num
  ),
  monitor = "val_loss",
  verbose = 0,
...
st = "intermediates/predictions/bGEV_local_PINN_homo_xi_fit"
dir.create(st)
save(
  pred_bGEV,
  pred_bGEV_boot,
  file = paste0(
    "intermediates/predictions/bGEV_local_PINN_homo_xi_fit/boot_",
    boot.num,
    ".Rdata"
  )
)
...
st = "intermediates/scores/bGEV_local_homo_xi_PINN"
dir.create(st)
save(
  nll,
  file = paste0(
    "intermediates/scores/bGEV_local_homo_xi_PINN/test_loss_",
    boot.num,
    ".Rdata"
  )
)
...
# Save model
model %>% save_model_tf(paste0(
  "intermediates/models/bGEV_local_homo_xi_PINN/boot_",
  boot.num
))
...
save(
  sMAD,
  file = paste0(
    "intermediates/scores/bGEV_local_homo_xi_PINN/sMAD_",
    boot.num,
    ".Rdata"
  )
)
...
save(
  twcrps,
  file = paste0(
    "intermediates/scores/bGEV_local_homo_xi_PINN/twCRPS_",
    boot.num,
    ".Rdata"
  )
)
...
save(
  ...
  file = paste0(
    "intermediates/models/bGEV_local_PINN_homo_xi_fit/linearcoeffs_boot_",
    boot.num,
    ".Rdata"
  )
)
