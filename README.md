...
```
This will also install the Python dependencies, via the R package `reticulate`.  You can then check if Keras is installed properly before proceeding:

```
Rscript keras_check.R 
```
